...
if(isset($_POST)){
 ...
 if($id && $envio){
    $sql = "UPDATE cotizaciones_invitado SET id_medida  = $envio,  estatus = 6 WHERE id_cotizacion = $id";
    $conexion->query($sql);
    $datos = $conexion->query("SELECT * FROM cotizaciones_invitado WHERE id_cotizacion = $id");
