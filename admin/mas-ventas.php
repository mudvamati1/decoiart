...
if ($_SERVER['REQUEST_METHOD'] == 'GET'){
    if (isset($_GET['id'])) {      
      ...
      $sql = $conexion->prepare("SELECT MAX(rut_vendedor) AS 'vendedor', COUNT(rut_vendedor) AS 'total' FROM ventas GROUP BY rut_vendedor ORDER BY COUNT(rut_vendedor) DESC LIMIT 1");
      $sql->execute();
