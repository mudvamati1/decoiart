...
$totalQuery = $conexion->query("SELECT COUNT(*) FROM vendedores") or die($conexion->error);
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6 text-right">
                            <button type="button" class="btn btn-primary" data-toggle="modal"
                                ...
                                <i class="fa fa-user-plus"></i> Agregar Vendedor
                            </button>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <form action="editar_vendedor1.php" method="POST">
                                ...
                                <div class="site-block-27 ">
                                    <ul class="list-group list-group-horizontal">
                                        ...
                                        if (isset($_GET['filtro']) && isset($_GET['orden']) && isset($_GET['rut'])) {
                                            ...
                                            if (isset($_GET['limite'])) {
                                                if ($_GET['limite'] > 0) {
                                                    echo '<li class="list-group-item"><a href="vendedores.php?limite=' . ($_GET['limite'] - 4) . '">&lt;</a></li>';
                                                }
                                            }
                                            for ($k = 0; $k < $totalBotones; $k++) {
                                                echo '<li class="list-group-item"><a href="vendedores.php?limite=' . ($k * 4) . '">' . ($k + 1) . '</a></li>';
                                            }
                                            if (isset($_GET['limite'])) {
                                                ...
                                                echo '<li class="list-group-item"><a href="vendedores.php?limite=4">&gt;</a></li>';
                                            }
                                        }
                ...
                <div class="modal-content">
                    <form action="insertar_vendedor.php" method="POST">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Agregar un vendedor</h5>
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="text" pattern="\d{3,8}-[\d|kK]{1}" name="rut" id="rut"
                                    placeholder="Rut del vendedor" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label for="nombre">Nombre</label>
                                <input type="text" pattern="[a-zA-Z]{2,254}" name="nombre" id="nombre"
                                    placeholder="Nombre del vendedor" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label for="apellidos">Apellidos</label>
                                <input type="text" pattern="[a-zA-Z]{2,254}" name="apellidos" id="apellidos"
                                    placeholder="Apellidos del vendedor" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label for="email">Correo</label>
                                <input type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" name="email"
                                    id="email" placeholder="E-mail del vendedor" class="form-control" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password"
                                    pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*_=+-]).{8,12}$" name="p2"
                                    id="password" class="form-control" placeholder="Ingrese una contraseña" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select name="region" pattern="\d{1,2}/\d{1,2}/\d{4}" id="region" class="form-control" required> </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="direccion" id="direccion" placeholder="Direccion del vendedor"
        ...
        <div class="modal fade" id="modalEliminar" tabindex="-1" role="dialog" aria-labelledby="modalEliminarLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalEliminarLabel">Eliminar Vendedor</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        ¿Esta seguro que desea eliminar al vendedor?
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
