...
if (isset($_POST['rut'])) {
    ...
    $resultado2 = $conexion->query("SELECT region FROM usuarios WHERE rut='$rut'");
                            ...
                            <div class="p-3 p-lg-5 border">
                                <form action="editar_usuario.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" pattern="[a-zA-Z]{2,254}" name="nombre" id="nombreEdit"
                                            placeholder="Nombre del usuario" class="form-control"
                                            value="<?= $fila[1] ?>" required>

                                    </div>
                                    <div class="form-group">
                                        <label for="apellidosEdit">Apellidos</label>
                                        <input type="text" pattern="[a-zA-Z]{2,254}" name="apellidos" id="apellidosEdit"
                                            value="<?= $fila[2] ?>" placeholder="Apellidos del usuario"
                                            class="form-control" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="emailEdit">Email</label>
                                        <input type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$"
                                            name="email" id="emailEdit" value="<?= $fila[3] ?>"
                                            placeholder="Email del usuario" class="form-control" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="direccion" id="direccionEdit" value="<?= $fila[7] ?>"
                                            placeholder="Direccion del usuario" class="form-control" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="estadoEdit">Estado</label>
                                        <input type="number" name="estado" id="estadoEdit" value="<?= $fila[9] ?>"
                                            min="0" max="1" placeholder="estado del usuario" class="form-control"
                                            required>
                                    </div>
