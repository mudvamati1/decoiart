      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-6">
            <div class="block-16">
              <figure>
                <img src="images/decoiart.jpg" alt="Image placeholder" class="img-fluid rounded">
          ...
          <div class="col-md-5">
            ...
            <div class="site-section-heading pt-3 mb-4">
              <h2 class="text-black">Acerca de Decoiart</h2>
            </div>
            ...
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  ...
                  <h3 class="block-38-heading h4">Brandon Sepulveda</h3>
                  <p class="block-38-subheading">CEO/Co-Fundador</p>
                </div>
            ...
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  ...
                  <h3 class="block-38-heading h4">Ismael Von dem Knesebeck</h3>
                  <p class="block-38-subheading">CEO/Co-Fundador</p>
                </div>
                <div class="block-38-body">
                  <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae aut minima nihil sit distinctio recusandae doloribus ut fugit officia voluptate soluta. </p>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="images/person_3.jpg" alt="Image placeholder" class="mb-4">
                  <h3 class="block-38-heading h4">Matias orellana</h3>
                  <p class="block-38-subheading">CEO/Co-Fundador</p>
                </div>
                <div class="block-38-body">
                  <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae aut minima nihil sit distinctio recusandae doloribus ut fugit officia voluptate soluta. </p>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="images/person_4.jpg" alt="Image placeholder" class="mb-4">
                  <h3 class="block-38-heading h4">Matias Acevedo</h3>
                  <p class="block-38-subheading">Jefe Area TI</p>
                </div>
                <div class="block-38-body">
                  <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae aut minima nihil sit distinctio recusandae doloribus ut fugit officia voluptate soluta. </p>
                </div>
