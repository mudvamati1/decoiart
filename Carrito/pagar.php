...
if (isset($_SESSION['datos_login'])) {
  ...
  $datos2 = $conexion->query("SELECT e.*, r.id, r.nombre, c.id, c.nombre FROM envios e
  ...
  $datos2 = $conexion->query("SELECT e.*, r.id, r.nombre, c.id, c.nombre FROM envios_invitado e
  INNER JOIN region r ON r.id = e.region
  INNER JOIN comuna c ON c.id = e.comuna
   WHERE id_venta=" . $_GET['id_venta']) or die($conexion->error);
  $datos_envio = mysqli_fetch_row($datos2);
...
$preference->back_urls = array(
  "success" => "https://localhost/Decoiart/Carrito/thankyou.php?id_venta=" . $_GET['id_venta'] . "&metodo=mercado_pago",
...
<body>
  <script src="https://www.paypal.com/sdk/js?client-id=Ad1FwfL34Q3h9AAvDRjf3I3nZMvc_TFKRoGz_2a5Bq0XpOirrW9GHgIRr-rLKyGHUGgYqMAMgd95ktpY&currency=USD"></script>
  <div class="site-wrap">
    ...
    </header><?php if (isset($_SESSION['datos_login'])) {
      ...
      <div class="container">
        <div class="row">
            ...
            <form action="#" method="post">
              ...
              <div class="p-3 p-lg-5 border">
                ...
                ?>
                  <div class="form-group row">
                    <div class="col-md-6">
                      <label for="c_fname" class="text-black">Rut: <?php echo $arregloUsuario['rut']; ?></label>
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-md-6">
                      <label for="c_fname" class="text-black">Nombre: <?php echo $arregloUsuario['nombre']; ?></label>
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-md-6">
                      <label for="c_fname" class="text-black">Apellido: <?php echo $arregloUsuario['apellido']; ?></label>
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-md-6">
                      <label for="c_fname" class="text-black">E-Mail: <?php echo $arregloUsuario['email']; ?></label>
                    </div>
                  </div>

                  <div class="form-group row">
                    <div class="col-md-6">
                      <label for="c_fname" class="text-black">Region: <?php echo $datos_envio[9]; ?></label>
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-md-6">
                  ...
                  <div class="form-group row">
                    <div class="col-md-6">
                      <label for="c_fname" class="text-black">Comuna: <?php echo $datos_envio[11]; ?></label>
                    </div>
                  </div>
                <?php } else { ?>
                  ...
                  <div class="form-group row">
                    <div class="col-md-6">
                      <label for="c_fname" class="text-black">Rut: <?php echo $datos_usuario[8]; ?></label>
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-md-6">
                      <label for="c_fname" class="text-black">Nombre: <?php echo $datos_usuario[9]; ?></label>
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-md-6">
                      <label for="c_fname" class="text-black">Apellido: <?php echo $datos_usuario[10]; ?></label>
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-md-6">
                      <label for="c_fname" class="text-black">E-Mail: <?php echo $datos_usuario[11]; ?></label>
                    </div>
                  </div>
          ...
          <div class="col-md-5 ml-auto">
            ...
            <?php if(isset($_SESSION['datos_login'])): ?>
            <h4 class="h1">Total:<?php echo $datos_usuario[2]; ?></h4>
            <?php else: ?>
              <h4 class="h1">Total:<?php echo $datos_usuario[5]; ?></h4>
              <?php endif; ?>
            <div class="checkout-btn">
              <form action="http://localhost/Decoiart/Carrito/thankyou.php?id_venta=<?php echo $_GET['id_venta'] ?>&metodo=mercado_pago" method="POST">

                <script src="https://www.mercadopago.cl/integrations/v1/web-payment-checkout.js" data-preference-id="<?php echo $preference->id;  ?>">
    ...
    paypal.Buttons({
      createOrder: function(data, actions) {
        return actions.order.create({
          purchase_units: [{
            amount: {
              value: Math.round('<?php echo $datos_usuario[2]; ?>' / 864),
    ...
    paypal.Buttons({
      createOrder: function(data, actions) {
        return actions.order.create({
          purchase_units: [{
            amount: {
              value: Math.round('<?php echo $datos_usuario[5]; ?>' / 864),
