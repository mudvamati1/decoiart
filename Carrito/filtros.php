...
if (isset($_SESSION['botones_filtros'])) {
          ...
          <div class="col-md-9 order-2">
              ...
              <div class="col-md-12 mb-5">
                <div class="float-md-left mb-4">
                  <?php if (isset($_GET['texto'])) {
                    echo '<h2 class="text-black h5">Ordenando resultados de ' . $_GET['texto'] . ' de ' . $_GET['para'] . '</h2>';
                  } else {
                    echo '<h2 class="text-black h5">Ordenando resultados de ' . $_GET['para'] . '</h2>';
                  }
            ...
            <div class="row mb-5">
              ...
              if (isset($_GET['id_categoria'])) {
                ...
                $totalQuery = $conexion->query("SELECT COUNT(*) FROM productos WHERE id_categoria = $botones") or die($conexion->error);
              ...
              if (isset($_GET['limite']) && isset($_GET['texto'])) {
                ...
                WHERE 
                 ...
                 categorias.nombre LIKE '%" . $_GET['texto'] . "%' AND
                 categorias.nombre = '" . $_GET['texto'] . "'
                
                 order by precio $orden  limit " . $_GET['limite'] . ", " . $limite) or die($conexion->error);
                ...
                WHERE 
                 ...
                 order by precio $orden   limit  " . $limite) or die($conexion->error);
                  ...
                  <ul>
                    ...
                    if (isset($_GET['id_categoria'])) {
                      if (isset($_GET['limite'])) {
                        if ($_GET['limite'] > 0) {
                          echo '<li><a href="filtros.php?id_categoria=' . $_GET['id_categoria'] . '&texto=' . ($_GET['texto']) . '&para=' . ($_GET['para']) . '&filtro=' . ($_GET['filtro']) . '&limite=' . ($_GET['limite'] - 10) . '">&lt;</a></li>';
                        }
                      }
                      for ($k = 0; $k < $totalBotones; $k++) {
                        echo '<li><a href="filtros.php?id_categoria=' . $_GET['id_categoria'] . '&texto=' . ($_GET['texto']) . '&para=' . ($_GET['para']) . '&filtro=' . ($_GET['filtro']) . '&limite=' . ($k * 10) . '">' . ($k + 1) . '</a></li>';
                      }
                      if (isset($_GET['limite'])) {
                        ...
                        echo '<li><a href="filtros.php?id_categoria=' . $_GET['id_categoria'] . '&texto=' . ($_GET['texto']) . '&para=' . ($_GET['para']) . '&filtro=' . ($_GET['filtro']) . '&limite=10">&gt;</a></li>';
                      }
                    } else {
                      if (isset($_GET['limite'])) {
                        if ($_GET['limite'] > 0) {
                          echo '<li><a href="filtros.php?texto=' . ($_GET['texto']) . '&para=' . ($_GET['para']) . '&filtro=' . ($_GET['filtro']) . '&limite=' . ($_GET['limite'] - 10) . '">&lt;</a></li>';
                        }
                      }
                      for ($k = 0; $k < $totalBotones; $k++) {
                        echo '<li><a href="filtros.php?texto=' . ($_GET['texto']) . '&para=' . ($_GET['para']) . '&filtro=' . ($_GET['filtro']) . '&limite=' . ($k * 10) . '">' . ($k + 1) . '</a></li>';
                      }
                      if (isset($_GET['limite'])) {
                        if ($_GET['limite'] + 10 < $totalBotones * 10) {
                          echo ' <li><a href="filtros.php?texto=' . ($_GET['texto']) . '&para=' . ($_GET['para']) . '&filtro=' . ($_GET['filtro']) . '&limite=' . ($_GET['limite'] + 10) . '">&gt;</a></li>';
                        ...
                        echo '<li><a href="filtros.php?texto=' . ($_GET['texto']) . '&para=' . ($_GET['para']) . '&filtro=' . ($_GET['filtro']) . '&limite=10">&gt;</a></li>';
                      }
                    }
            ...
            <div class="border p-4 rounded mb-4">
              ...
              <div class="mb-4">
                ...
                <label for="s_sm" class="d-flex">
                  <a href="./filtros.php?limite=0&filtro=ASC&para=Menor a Mayor&texto=<?php if (isset($_GET['texto'])) {
                                                                                        echo $variable;
                                                                                      } else {
                                                                                        echo "";
                                                                                      } ?>">
                ...
                <label for="s_md" class="d-flex">
                  <a href="./filtros.php?limite=0&filtro=DESC&para=Mayor a Menor&texto=<?php if (isset($_GET['texto'])) {
                                                                                          echo $variable;
                                                                                        } else {
                                                                                          echo "";
                                                                                        } ?>">
