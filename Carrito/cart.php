...
if (isset($_SESSION['carrito'])) {
  //Si existe buscamos si estaba agregado este producto
  if (isset($_GET['id']) && $_GET['marketplace']) {
    ...
    if ($encontro == true) {
      ...
      $mail[$numero]['Cantidad'] = $mail[$numero]['Cantidad'] + 1;
      ...
      array_push($mail, $mailNuevo);
      $_SESSION['carrito'] = $arreglo;
      $_SESSION['mail'] = $mail;
      header("Location: ./cart.php");
    }
  } else if (isset($_GET['id']) && isset($_GET['marketplace'])) {
    $arreglo = $_SESSION['carrito'];
    $mail = $_SESSION['mail'];
    $encontro = false;
    $numero = 0;
    ...
    if ($encontro == true) {
      $arreglo[$numero]['Cantidad'] = $arreglo[$numero]['Cantidad'] + 1;
      $mail[$numero]['Cantidad'] = $arreglo[$numero]['Cantidad'] + 1;
      $_SESSION['carrito'] = $arreglo;
      $_SESSION['mail'] = $mail;
    } else {
      //No estaba el registro
  ...
  if (isset($_GET['id']) && isset($_GET['decoiart'])) {
    $nombre = "";
    $precio = "";
    $imagen = "";
    $res = $conexion->query('SELECT * FROM cuadros WHERE id=' . $_GET['id']) or die($conexion->error);
                  ...
                  ?>
                      <tr>
                        <td class="product-thumbnail">
                          <img src="images/<?php echo $arregloCarrito[$i]['Imagen']; ?>" alt="Image" width="150px" height="120px">
                        </td>
                        ...
                        <td>
                          <div class="input-group mb-3" style="max-width: 120px;">
                            ...
                            <input type="number" min="1" class="form-control text-center txtCantidad" data-precio="<?php echo $arregloCarrito[$i]['Precio']; ?>" data-id="<?php echo $arregloCarrito[$i]['Id']; ?>" value="<?php echo $arregloCarrito[$i]['Cantidad']; ?>" placeholder="" aria-label="Example text with button addon" aria-describedby="button-addon1">
