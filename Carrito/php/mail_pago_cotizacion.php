...
if (isset($_POST['correo'])) {
    ...
    $message .= '   <a href="http://localhost/Decoiart/Carrito/pagar_cotizacion.php?logeado=logeado&id_venta=' . $cotizacion['id_cotizacion'] . '" style="background-color:brown;color:white;padding:10px;text-decoration: none;">
    Pagar cotizacion
    </a> 
    </body>
