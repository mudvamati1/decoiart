        ...
        <div class="row justify-content-md-center" style="margin-top:15%">
            ...
            <form class="col-3" action="./cambiarpassword.php" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control" id="c" name="p1" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*_=+-]).{8,}$" title="Debe tener al menos una mayuscula, un caracter especial y un numero" required>

                </div>
                <div class="mb-3">
                    <label for="c" class="form-label">Confirmar Password</label>
                    <input type="password" class="form-control" id="c" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*_=+-]).{8,}$" title="Debe tener al menos una mayuscula, un caracter especial y un numero"  name="p2" required>
