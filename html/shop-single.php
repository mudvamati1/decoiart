...
if (isset($_GET['id'])) {
    $resultado = $conexion->query("SELECT c.*, v.nombre, v.apellidos FROM cuadros c
    INNER JOIN usuarios v ON v.rut = c.vendedor
    ...
    <?php include './header.php' ?>
        ...
        <div class="site-section">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <img src="../Carrito/images/<?php echo $fila[3] ?>" alt="Image" class="img-fluid">
                    </div>
                    <div class="col-md-6">
                        <h2 class="text-black"><?php echo $fila[1] ?></h2>
                        <p>Medidas: <?php echo $fila[2] ?></p>
                        <p><strong class="text-primary h4">Precio: $<?php echo $fila[5] ?></strong></p>
                        <p><strong class="text-primary h4">Stock: <?php echo $fila[6] ?></strong></p>
                        <p><strong class="text-primary h4">Caracteristicas: <?php echo $fila[4] ?>


                                <p><strong class="text-primary h4">Vendedor: <?php echo $fila[9].' '.$fila[10]  ?></strong></p>


                                <p><a href="../Carrito/cart.php?decoiart=decoiart&id=<?php echo $fila[0] ?>" class="buy-now btn btn-sm btn-primary">Añadir al carrito</a></p>
